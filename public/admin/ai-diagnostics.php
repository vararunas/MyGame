...
try{$db=Connection::make();$engine=new GameEconomyEngine($db);$gameDate=$engine->sync();$audit=$engine->auditAndRepairAiCycles($gameDate);$engine->runAutoAccountingForAll();
